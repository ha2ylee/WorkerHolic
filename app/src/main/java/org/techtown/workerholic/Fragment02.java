...
public class Fragment02 extends Fragment {
    ...
    String codeNumber;
    String part1start,part1end,part1edt,part2start,part2end,
            part2edt,part3start,part3end,part3edt,part4start,
            part4end,part4edt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView part1_edt = (TextView) rootView.findViewById(R.id.part1_edt);
        TextView part2_edt = (TextView) rootView.findViewById(R.id.part2_edt);
        TextView part3_edt = (TextView) rootView.findViewById(R.id.part3_edt);
        TextView part4_edt = (TextView) rootView.findViewById(R.id.part4_edt);
        ...
        mDatabaseRef.child("Group").child(codeNumber).child("part1_edt").addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                part1_edt.setMovementMethod(new ScrollingMovementMethod());
